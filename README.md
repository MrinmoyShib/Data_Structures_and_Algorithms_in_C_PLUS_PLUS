...
| :--- | :---: | :--- |
| **Data Structures** | 🏗️ | Arrays, Linked Lists, Trees, Graphs |
| **Algorithms** | ⚡ | Sorting, Searching, DP, Backtracking |
| **Complexity** | 📉 | Big O Notation, Space/Time Optimization |
| **Solutions** | 🏆 | LeetCode, HackerRank, Codeforces |
...
| :--- | :--- | :---: |
| 1 | **Fundamentals:** Big O & Arrays | ✅ |
| 2 | **Linear DS:** Stacks & Queues | 🏗️ |
| 3 | **Non-Linear:** Trees & Graphs | ⏳ |
| 4 | **The Boss Level:** Dynamic Programming | 🔒 |
...
I’m building this in public to stay accountable. 

* **Found a bug?** Open an 📂 **Issue**.
* **Better approach?** Submit a 🌿 **Pull Request**.
* **Support:** If this helps you, give it a ⭐ **Star**!

> "The only way to learn a new programming language is by writing programs in it." — *Dennis Ritchie*

<p align="center">
  <img src="https://views.whatilearened.today/views/github/MrinmoyShib/Data_Structures_and_Algorithms_in_C_PLUS_PLUS.svg" alt="Views" />
</p>
